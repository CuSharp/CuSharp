...
public static class KernelTools
{
    ...
    public static Action CallGlobalThreadFenceAction { get; set; } = () => throw new NotSupportedException(ErrorMessage);
    public static Action CallSystemThreadFenceAction { get; set; } = () => throw new NotSupportedException(ErrorMessage);
    ...
    public static Action GlobalThreadFence => CallSyncThreadsAction;
    public static Action SystemThreadFence => CallSyncThreadsAction;

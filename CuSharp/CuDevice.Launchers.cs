...
public partial class CuDevice
{
    ...
    {
        object[] parameters = new object[] {param0, param1};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
    ...
    {
        object[] parameters = new object[] {param0, param1, param2};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
   }
    ...
    {
        object[] parameters = new object[] {param0, param1, param2, param3};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
    }
    ...
    {
        object[] parameters = new object[] {param0, param1, param3, param4};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
    }
    ...
    {
        object[] parameters = new object[] {param0, param1, param2, param3, param4, param5};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
    }
    ...
    {
        object[] parameters = new object[] {param0, param1,param2, param3, param4, param5, param6};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
    }
    ...
    {
        object[] parameters = new object[] {param0, param1, param2, param3, param4, param5, param6, param7};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
    }
    ...
    {
        object[] parameters = new object[] {param0, param1, param2, param3, param4, param5, param6, param7, param8};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
    }
    ...
    {
        object[] parameters = new object[] {param0, param1, param2, param3, param4, param5, param6, param7, param8, param9};
        _launcher.CompileAndLaunch(method.GetMethodInfo(), gridSize, blockSize, parameters);
    }
}
